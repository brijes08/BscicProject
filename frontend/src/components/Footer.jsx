          ...
          <div className="row">
            <div className="col-sm-12 col-md-5">
              ...
              <p className="text-justify">
                brijes.in <i>CODE WANTS TO BE SIMPLE </i> is an initiative
                to help the upcoming programmers with the code. Brijes Singh
              ...
              <ul className="social-icons">
                <li>
                  <a
                    className="facebook"
                    target="_brijes"
                    href="https://www.facebook.com/Brijes08/"
                  >
                ...
                <li>
                  <a
                    className="twitter"
                    target="_brijes"
                    href="https://twitter.com/brijes08"
                  >
                ...
                <li>
                  <a
                    className="instagram"
                    target="_brijes"
                    href="https://www.instagram.com/brijes08/"
                  >
                ...
                <li>
                  <a
                    className="linkedin"
                    target="_brijes"
                    href="https://www.linkedin.com/in/brijes08/"
                  >
          ...
          <div className="row">
            ...
            <div className="col-md-4 col-sm-6 col-xs-12">
              <p className="developed-text">
                Powered by
                <a target="_brijes" href="https://brijes.netlify.app/"> Brijesh Singh</a>
              </p>
            </div>
          </div>
        </div>
